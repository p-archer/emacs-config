...
** Org settings
   ...
   #+BEGIN_SRC emacs-lisp
	 ...
	 (setq aws-url (concat ssh-method ":carnifex@35.178.58.103:"))
	 ...
	 (setq org-shopping-file (concat aws-url "/home/carnifex/org/shopping.org"))
	 ...
	 (defun open-shopping-org-file ()
		 (interactive)
		 (custom/open-in-split org-shopping-file))

	 (setq org-capture-templates
		   '(("t" "todo" entry (file+headline org-projects-file "inbox")
			  "* TODO %?\n  :PROPERTIES:\n  :added: %T\n  :END:\n%^{effort}p" :prepend t :kill-buffer t)
			 ("l" "linked todo" entry (file+headline org-projects-file "inbox")
			  "* TODO %?\n  :PROPERTIES:\n  :added: %T\n  :Link: %a\n  :END:\n%^{effort}p" :prepend t :kill-buffer t)
			 ("s" "shop" entry (file+headline org-shopping-file "inbox")
			  "* BUY %?\n  :PROPERTIES:\n  :added: %T\n  :END:\n" :prepend t :kill-buffer t)
			 ("i" "idea/someday" entry (file+headline org-ideas-file)
			  "* TODO %?\n  :PROPERTIES:\n  :added: %T\n  :END:\n" :prepend t :kill-buffer t)))

	 (setq org-refile-targets '((org-projects-file :maxlevel . 1)
	                            (org-shopping-file :maxlevel . 1)))
